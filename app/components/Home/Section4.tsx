        ...
        <>
            <div className="bg-red-50">
                <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6  lg:max-w-7xl lg:px-8 lg:flex lg:items-center lg:justify-between">
                    <div className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-2xl">
                        <span className="block">Are you an education or digital enthusiast?</span>
                        <p>
            ...
            <div className="bg-white pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
                <div className="relative max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
                    <div>
                        <h2 className="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">Explore some of our past events</h2>
                    </div>
                    <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
                        {posts.map((post) => (
                            <div key={post.title} className="flex flex-col p-4  border-2 border-black rounded-none overflow-hidden">
                                <div className="flex-shrink-0">
                                    <img className="h-52 w-full" src={post.imageUrl} alt="" />
                                </div>
