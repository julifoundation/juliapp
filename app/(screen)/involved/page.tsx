...
const page = () => {
    return (
        <div>
            <Nav />
            <div className="py-20 bg-white sm:py-32">
                <div className="max-w-md mx-auto pl-4 pr-8 sm:max-w-lg sm:px-6 lg:max-w-7xl lg:px-8">
                    <h1 className="text-2xl font-extrabold tracking-tight text-red-600 uppercase text-center ">
                        Change a Life
                    </h1>
                    <p className="mt-1 font-bold max-w-3xl mx-auto text-4xl leading-normal text-gray-900 text-center">
                        Get Involved
                    </p>
                </div>
            </div>
            ...
            <div className="mx-auto py-4 px-4 max-w-7xl sm:px-6 lg:px-8 ">
                ...
                <h3 className='font-bold text-base text-black'>You can provide support through:</h3>
                ...
                <h3 className='font-bold text-base text-black py-2 '>Project Sponsorship: </h3>
