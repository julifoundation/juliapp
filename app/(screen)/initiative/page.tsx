        ...
        <>
            ...
            <div className="mt-12">
                <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                    <h2 className="text-4xl py-3 font-extrabold text-[#001538] main tracking-tight ">
                        Our Initiatives
                    </h2>
                    <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
                        <div id='eman' >
                            <h2 className="text-xl font-extrabold text-[#001538] main">
                        ...
                        <div className="mt-2 grid grid-cols-1 gap-0.5 ">
                            <div className="col-span-1 flex justify-center">
                                <img className="w-full h-full object-cover" src="https://ik.imagekit.io/kowe/JuliFoundation/IMG_9700.png?updatedAt=1704547610168" alt="julifoundation" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="mt-12">
                <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                    <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
                        <div className="mt-2 grid grid-cols-1 gap-0.5 ">
                            <div className="col-span-1 flex justify-center">
                                <img className="w-full h-full object-cover" src="https://ik.imagekit.io/kowe/JuliFoundation/IMG_9691.png?updatedAt=1704548133700" alt="julifoundation" />
                            </div>
                        </div>
                        <div id='win'>
                            <h2 className="text-xl font-extrabold text-[#001538] main">
            ...
            <div className="my-12">
                <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                    <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
                        ...
                        <div className="mt-2 grid grid-cols-1 gap-0.5 ">
                            <div className="col-span-1 flex justify-center">
                                <img className="w-full h-full object-cover" src="https://ik.imagekit.io/kowe/JuliFoundation/IMG_9666.png?updatedAt=1704548272240" alt="julifoundation" />
                            </div>
                        </div>
            ...
            <div className="my-12">
                <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                    <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
                        <div className="mt-2 grid grid-cols-1 gap-0.5 ">
                            <div className="col-span-1 flex justify-center">
                                <img className="w-full h-full object-cover" src="https://ik.imagekit.io/kowe/JuliFoundation/IMG_9696.png?updatedAt=1704548355480" alt="julifoundation" />
                            </div>
                        </div>
                        <div id='mentor'>
                            <h2 className="text-xl font-extrabold text-[#001538] main">
            ...
            <div className="mt-12">
                <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                    <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
                        ...
                        <div className="mt-2 grid grid-cols-1 gap-0.5 ">
                            <div className="col-span-1 flex justify-center">
                                <img className="w-full h-full object-cover" src="https://ik.imagekit.io/kowe/JuliFoundation/IMG_9690.png?updatedAt=1704548775247" alt="julifoundation" />
                            </div>
                        </div>
